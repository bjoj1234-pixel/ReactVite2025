        ...
        <>
            <div className="container">
                ...
                <div className="right-list">
                    <MenuList foodMenu={foodMenu} sideMenu={sideMenu} drinkMenu={drinkMenu} selMenu={selMenu} addCart={addCart}/>
                </div>
                {/* 우측 고정 장바구니 버튼 */}
                <button type="button" onClick={()=>setShowCart(!showCart)} class="cart-button"></button>
                {/* 장바구니 모달 */}
